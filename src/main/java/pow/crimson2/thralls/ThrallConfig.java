...
public class ThrallConfig {
    ...
    public boolean isHumanBloodDrawEnabled() {
        return config.getBoolean("thrall.human-blood-draw.enabled", false);
    }

    /** If true, only humans who are currently thralls can draw their own blood. */
    public boolean isHumanBloodDrawThrallsOnly() {
        return config.getBoolean("thrall.human-blood-draw.thralls-only", true);
    }

    public double getHumanBloodDrawDamageHearts() {
        return config.getDouble("thrall.human-blood-draw.damage-hearts", 2.0);
    }

    public int getHumanBloodDrawCooldownSeconds() {
        return config.getInt("thrall.human-blood-draw.cooldown-seconds", 30);
    }
    ...
    public boolean isAnimalBloodDrawEnabled() {
        return config.getBoolean("blood-draw.animal.enabled", false);
    }

    /** Whether humans (non-vampires, non-thralls) can collect animal blood. */
    public boolean isAnimalBloodDrawAllowHumans() {
        return config.getBoolean("blood-draw.animal.allow-humans", true);
    }

    /** Whether vampires can collect animal blood. */
    public boolean isAnimalBloodDrawAllowVampires() {
        return config.getBoolean("blood-draw.animal.allow-vampires", false);
    }

    /** Whether thralls (human thralls) can collect animal blood. */
    public boolean isAnimalBloodDrawAllowThralls() {
        return config.getBoolean("blood-draw.animal.allow-thralls", true);
    }

    public double getAnimalBloodDrawDamageHearts() {
        return config.getDouble("blood-draw.animal.damage-hearts", 2.0);
    }

    public int getAnimalBloodDrawCooldownSeconds() {
        return config.getInt("blood-draw.animal.cooldown-seconds", 60);
    }

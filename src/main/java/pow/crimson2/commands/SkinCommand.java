...
public class SkinCommand implements CommandExecutor, TabCompleter {
    ...
    private static final List<String> SUB_PLAYER = List.of("register", "apply", "clear", "list");
    private static final List<String> SUB_ADMIN  = List.of("register", "apply", "clear", "list", "reload");

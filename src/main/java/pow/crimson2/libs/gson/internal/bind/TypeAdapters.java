...
import pow.crimson2.libs.gson.JsonArray;
import pow.crimson2.libs.gson.JsonElement;
import pow.crimson2.libs.gson.JsonIOException;
import pow.crimson2.libs.gson.JsonNull;
import pow.crimson2.libs.gson.JsonObject;
import pow.crimson2.libs.gson.JsonPrimitive;
         ...
         try {
            Field[] constantFields = AccessController.doPrivileged(new PrivilegedAction<Field[]>() {
               public Field[] run() {
                  ...
                  Field[] constantFieldsx = constantFieldsList.toArray(new Field[0]);
                  AccessibleObject.setAccessible(constantFieldsx, true);
                  return constantFieldsx;
               }
            });

...
public class VampireSMPPlugin extends JavaPlugin {
   ...
   public void onEnable() {
      ...
      // Register the ghost voice-haunt add-on with Simple Voice Chat, if present.
      try {
         de.maxhenkel.voicechat.api.BukkitVoicechatService vcService =
                 this.getServer().getServicesManager().load(de.maxhenkel.voicechat.api.BukkitVoicechatService.class);
         if (vcService != null) {
            vcService.registerPlugin(new pow.crimson2.ghost.GhostVoicechatPlugin(this));
